// <copyright file="IocContainerTest.cs" company="BIATeam">
//     Copyright (c) BIATeam. All rights reserved.
// </copyright>
namespace BIATeam.BIAMonitoring.Test.IoC
{
    using System;
    ...
    public static class IocContainerTest
    {
        ...
        public static void ConfigureContainerTest(IServiceCollection services)
        {
            ...
            RegisterControllersFromAssembly(services, "BIATeam.BIAMonitoring.Presentation.Api");
        }
