// <copyright file="IocContainer.cs" company="BIATeam">
//     Copyright (c) BIATeam. All rights reserved.
// </copyright>

namespace BIATeam.BIAMonitoring.Crosscutting.Ioc
{
    using System;
    ...
    public static class IocContainer
    {
        ...
        private static void ConfigureApplicationContainer(IServiceCollection collection, bool isApi)
        {
            ...
            BiaIocContainer.RegisterServicesFromAssembly(
                ...
                assemblyName: "BIATeam.BIAMonitoring.Application",
        ...
        private static void ConfigureDomainContainer(IServiceCollection collection)
        {
            ...
            BiaIocContainer.RegisterServicesFromAssembly(
                collection: collection,
                assemblyName: "BIATeam.BIAMonitoring.Domain",
                serviceLifetime: ServiceLifetime.Transient);

            Type templateType = typeof(BaseMapper<,,>);
            Assembly assembly = Assembly.Load("BIATeam.BIAMonitoring.Domain");
        ...
        private static void ConfigureInfrastructureDataContainer(IServiceCollection collection, IConfiguration configuration)
        {
            ...
            BiaIocContainer.RegisterServicesFromAssembly(
                collection: collection,
                assemblyName: "BIATeam.BIAMonitoring.Infrastructure.Data",
                interfaceAssemblyName: "BIATeam.BIAMonitoring.Domain",
                serviceLifetime: ServiceLifetime.Transient);
